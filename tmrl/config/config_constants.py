...
IMG_CROP_TOP = ENV_CONFIG["IMG_CROP_TOP"] if "IMG_CROP_TOP" in ENV_CONFIG else 0
IMG_CROP_BOTTOM = ENV_CONFIG["IMG_CROP_BOTTOM"] if "IMG_CROP_BOTTOM" in ENV_CONFIG else 0
IMG_CROP_SIDES = ENV_CONFIG["IMG_CROP_SIDES"] if "IMG_CROP_SIDES" in ENV_CONFIG else 0
